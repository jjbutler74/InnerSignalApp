      ...
      <View style={s.root}>
        ...
        <View style={{ flex: 1, justifyContent: 'flex-end' }}>
          <View style={s.card}>
            ...
            <Eyebrow style={{ color: lightTokens.night, marginBottom: 6 }}>
...
const s = StyleSheet.create({
  ...
  appIcon:         { width: 18, height: 18, borderRadius: 5, backgroundColor: lightTokens.night, alignItems: 'center', justifyContent: 'center' },
